...
class DataService {
  ...
  private resources: Resource[] = [
    ...
    },
    {
      ...
      address: '16 Whampoa Dr, Singapore 327725',
      phone: '+65 6254 3006',
      website: 'https://hwa.org.sg/transport-services',
    ...
    },
    {
      ...
      address: 'Visit our website to find the nearest one for you!',
      phone: '1800-650-6060',
      website: 'https://www.aic.sg/care-services/active-ageing-centres',
    ...
    },
    {
      ...
      category: 'social',
      description: 'Monthly support meetings and activities for family caregivers and professional support staff.',
      address: '3 Ghim Moh Rd, #01-294 Block 3, Singapore 270003',
      phone: '+65 6466 7996',
      website: 'https://www.cwa.org.sg/caregiver-support-group',
      hours: 'Thursdays 8:30AM-6PM',
      rating: 3.8,
      distance: '27.7 kilometres',
    ...
    },
    {
      ...
      category: 'support',
      description: 'Voluntary Welfare Organization that conducts workshops and trainings for caregivers',
      address: 'Country-wide',
      phone: '+65 6681 4928',
      website: 'https://www.lionsbefrienders.org.sg/workshops-and-trainings', 
      hours: 'Mon-Fri 9AM-6PM',
      rating: 4.5,
      distance: 'Country-wide',
      services: ['Support Groups', 'Educational Workshops'],
      verified: true
    },
    {
      id: '6',
