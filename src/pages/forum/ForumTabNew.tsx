    ...
    <div className="max-w-5xl mx-auto px-4 py-8 bg-gray-50 min-h-screen">
      ...
      {threads.length === 0 ? (
        <div className="text-center py-8">
          <p className="text-gray-600">No threads found. Be the first to start a discussion!</p>
        </div>
      ) : (
        <div className="space-y-4">
          {threads.map((thread, index) => (
            ...
            >
              {/* Icon */}
              <div className={`w-10 h-10 flex items-center justify-center rounded-full mr-4 ${getThreadColor(index)}`}>
